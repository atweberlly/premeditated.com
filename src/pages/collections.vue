<template>
  ...
  <main>
    <section class="relative overflow-hidden py-8 sm:py-12 md:py-16 lg:py-24 xl:py-32">
      <img
        class="hidden select-none opacity-90 md:absolute md:bottom-1/2 md:block md:translate-y-1/2 xl:right-0 xl:bottom-8 xl:max-w-4xl xl:translate-y-0 2xl:right-32"
        src="/img/bg/starfield-06.png"
        alt=""
      />
      <div class="px-8 xl:mx-auto xl:max-w-6xl xl:px-0">
        <div
          class="grid grid-cols-1 gap-4 rounded-2xl border border-white/25 supports-backdrop-blur:backdrop-blur-lg md:grid-cols-2 md:items-center md:justify-between md:gap-0"
        >
          <h1 class="px-8 pt-8 text-center md:pt-0 md:text-left xl:pl-16 xl:pr-0">
            <span class="block font-display text-3xl tracking-widest lg:text-5xl xl:text-6xl">
              Straight
            </span>
            <span class="mt-2 block text-2xl lg:text-4xl">Space Babe</span>
            <span class="mt-2 block font-display text-2xl tracking-widest text-spring lg:text-3xl">
              Collection
            </span>
          </h1>
    ...
    <section class="px-8 py-8 sm:py-12 md:py-16 lg:py-24 xl:relative xl:py-32">
      <div class="hidden xl:absolute xl:top-48 xl:left-0 xl:inline-block xl:rotate-180">
        <a
          class="inline-block bg-purple px-2 py-4 text-2xl font-bold uppercase text-black writing-ltr"
          href="#"
        >
          Get 10% Off
        </a>
      ...
      <div class="mt-8 xl:mx-auto xl:max-w-5xl" role="grid">
        <div
          class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3 lg:gap-x-10 lg:gap-y-12"
          role="row"
        >
      ...
      <div class="mt-8">
        <button class="mx-auto block border-2 border-spring px-4 py-2" type="button">
          View more
        </button>
      </div>
    </section>
