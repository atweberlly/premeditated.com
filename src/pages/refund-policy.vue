<template>
  <article class="prose prose-invert mx-auto px-8 py-8 md:px-0">
    <h1 id="refund-policy">Refund Policy</h1>
    <p>
    ...
    <p>
      ...
      <a href="mailto:hello@premeditatedbeauty.com">hello@premeditatedbeauty.com</a>. If your return
      is accepted, we'll send you a return shipping label, as well as instructions on how and where
      to send your package. Items sent back to us without first requesting a return will not be
      accepted.
    </p>
    <p>
      You can always contact us for any return question at
      <a href="mailto:hello@premeditatedbeauty.com">hello@premeditatedbeauty.com</a>.
    </p>
    <h2 id="damages-and-issues">Damages and Issues</h2>
    <p>
    ...
    <h2 id="exceptionsnon-returnable-items">Exceptions/Non-returnable items</h2>
    <p>
      ...
      flammable liquids, or gases. Please get in touch if you have questions or concerns about your
      specific item.
    </p>
    ...
    <p>
      ...
      payment method. Please remember it can take some time for your bank or credit card company to
