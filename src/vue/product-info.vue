  ...
  <main>
    <section class="max-w-screen-lg px-8 py-8 sm:py-12 md:py-16 lg:py-24 xl:mx-auto xl:py-32">
      <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
        <div>
          <div class="relative">
            <div class="absolute top-4 right-4 inline-block rounded-full bg-spring px-3 py-1 text-sm font-medium text-black">Only 5 left</div>
            <img src="/img/collection/wig-06.jpg" alt="Queen of the Martians" />
          </div>
          <img class="hidden md:mt-8 md:block" src="/img/collection/wig-06.jpg" alt="Queen of the Martians" />
        </div>
