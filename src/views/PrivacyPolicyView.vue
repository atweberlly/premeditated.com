<template>
  <article class="prose prose-invert mx-auto px-8 py-8 md:px-0">
    <h1 id="privacy-policy">Privacy Policy</h1>
    <p>
      This Privacy Policy describes how premeditatedbeauty.com (the "Site" or "we") collects, uses,
      and discloses your Personal Information when you visit or make a purchase from the Site.
    </p>
    <h2 id="collecting-personal-information">Collecting Personal Information</h2>
    <p>
      ...
      below) as "Personal Information". See the list below for more information about what Personal
    ...
    <ul>
      <li>
        ...
        address, time zone, cookie information, what sites or products you view, search terms, and
      ...
      <li>
        ...
        using cookies, log files, web beacons, tags, or pixels [ADD OR SUBTRACT ANY OTHER TRACKING
        TECHNOLOGIES USED].
      </li>
      <li>
        <strong>Disclosure for a business purpose:</strong> shared with our processor Shopify [ADD
        ANY OTHER VENDORS WITH WHOM YOU SHARE THIS INFORMATION].
      </li>
    </ul>
    ...
    <ul>
      <li>
        ...
        information (including credit card numbers [INSERT ANY OTHER PAYMENT TYPES ACCEPTED]), email
        address, and phone number.
      </li>
      <li>
        Purpose of collection: to provide products or services to you to fulfill our contract, to
        process your payment information, arrange for shipping, and provide you with invoices and/or
      ...
      <li>
        Disclosure for a business purpose: shared with our processor Shopify [ADD ANY OTHER VENDORS
        WITH WHOM YOU SHARE THIS INFORMATION. FOR EXAMPLE, SALES CHANNELS, PAYMENT GATEWAYS,
    ...
    <ul>
      <li>
        Examples of Personal Information collected: [MODIFICATIONS TO THE INFORMATION LISTED ABOVE
    ...
    <p>
      The Site is not intended for individuals under the age of [INSERT AGE]. We do not
      intentionally collect Personal Information from children. If you are the parent or guardian
      and believe your child has provided us with Personal Information, please contact us at the
